...
class FaceRecognitionApp:
        ...
        if hasattr(self, 'video_path'):
            ...
            def process_frame(frame):
                ...
                for (x, y, w, h) in faces:
                    ...
                    # Check if face meets certain criteria (e.g., face size)
    ...
    def is_valid_face(self, face_region):
        # Example: Save face only if its width is greater than 50 pixels
        return face_region.shape[1] > 50
