...
class FaceDetectionApp:
    def __init__(self, master):
        ...
        self.detect_button = tk.Button(master, text="Detect Faces", command=self.detect_faces)
    ...
    def detect_faces(self):
        if hasattr(self, 'video_path'):
            ...
            self.label.config(text=f"Faces Detected! Saved as: {os.path.basename(output_path)}")
        else:
