...
def add_text_to_video(video_path, texts, output_path):
    ...
    # Iterate through video frames and texts
    for frame, text in zip(video_clip.iter_frames(fps=fps, dtype='uint8'), texts):
...
# with your actual video file, list of desired texts, and output file paths
